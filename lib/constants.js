...
exports.deTranslation = {
    ...
    SINGLEGARMENTS: "EinzelstÃ¼cke",
    DEODORIZATION: "Geruchsbeseitigung",
    EASYIRON: "Leichtes BÃ¼geln",
    ECONOMICDRY: "Eco Trocknen",
    BIGSIZEITEM: "ÃœbergrÃ¶sse",
    ...
    STEAMSOFTENER_OFF: "Dampf WeichspÃ¼ler aus",
    STEAMSOFTENER_ON: "Dampf WeichspÃ¼ler an",
    ECOHYBRID_OFF: "ECO aus",
    ECOHYBRID_ON: "ECO an",
    MEDICRINSE_OFF: "Medizinische SpÃ¼lung aus",
    MEDICRINSE_ON: "Medizinische SpÃ¼lung an",
    RINSE_SPIN_OFF: "SpÃ¼len und Schleudern aus",
    RINSE_SPIN_ON: "SpÃ¼len und Schleudern an",
    PREWASH_OFF: "VorwÃ¤sche aus",
    PREWASH_ON: "VorwÃ¤sche an",
    STEAM_OFF: "Dampf aus",
    STEAM_ON: "Dampf an",
    ...
    DOOR_LOCK_OFF: "TÃ¼rverschluss aus",
    DOOR_LOCK_ON: "TÃ¼rverschluss an",
    CHILDLOCK_OFF: "Kindersicherung aus",
    CHILDLOCK_ON: "Kindersicherung an",
    NO_RINSE: "Kein SpÃ¼len",
    RINSE_NORMAL: "Normal", 
    RINSE_PLUS: "SpÃ¼len+", 
    RINSE_PLUSPLUS: "SpÃ¼len++",
    RINSE_NORMAL_HOLD: "Normal SpÃ¼len",
    RINSE_PLUS_HOLD: "Normal SpÃ¼len+",
    courseFL24inchBaseTitan: "Programm", 
    smartCourseFL24inchBaseTitan: "Download Programm",
    proofing: "ImprÃ¤gnieren",
    ...
    steamSoftener: "Dampf WeichspÃ¼ler",
    ecoHybrid: "ECO Hybrid",
    medicRinse: "Medizinische SpÃ¼lung",
    rinseSpin: "SpÃ¼len und Schleudern",
    preWash: "VorwÃ¤sche",
    steam: "Dampf",
    initialBit: "EinschaltverzÃ¶gerung",
    remoteStart: "Fernzugriff",
    doorLock: "TÃ¼rverriegelung",
    childLock: "Kinderschutz",
    SEL_PROGRAM: "Programauswahl",
    MON_DEVICE: "GerÃ¤te Ãœberwachung",
    FAVORITE: "Favorit aus der APP laden",
    LASTCOURSE: "Die letzten 10 WaschgÃ¤nge",
    ...
    DAMPDRYBEEP_OFF: "Signal BÃ¼gelfeucht aus",
    DAMPDRYBEEP_ON: "Signal BÃ¼gelfeucht an",
    DNNREADY_OFF: "DNN Ready aus",
    DNNREADY_ON: "DNN Ready an",
    NO_DRYLEVEL: "Kein Trocknungsgrad",
    DRYLEVEL_IRON: "BÃ¼geltrocken",
    ...
    HANDIRON_OFF: "BÃ¼geltrocken aus",
    HANDIRON_ON: "BÃ¼geltrocken an",
