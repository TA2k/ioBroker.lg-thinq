...
module.exports = {
    ...
    async createStatistic(devicedp, model) {
        try {
            ...
            await this.createDataPoint(devicedp + ".remote.Statistic.period", commons);
     ...
     * @param {string} type
     */
    async sendStaticRequest(device, type) {
        try {
            ...
            const lasturl = "period=" + per + "&startDate=" + startD + "&endDate=" + endD;
            if (type === "air") {
                if (com.val === 0) {
